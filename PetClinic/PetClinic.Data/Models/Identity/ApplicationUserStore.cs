...
namespace PetClinic.Data.Models.Identity
{
...

    {
        ...
        public async Task<ApplicationUser> FindByIdAsync(string userId, CancellationToken cancellationToken)
        {
            try
            {
                cancellationToken.ThrowIfCancellationRequested();
                ThrowIfDisposed();
                var applicationUser = await _unitOfWork.UserRepository.GetByIdAsync(userId);
        ...
        public async Task<ApplicationUser> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken)
        {
            try
            {
                cancellationToken.ThrowIfCancellationRequested();
                ThrowIfDisposed();
                var applicationUser = await _unitOfWork.UserRepository.GetFirstOrDefaultAsync(u => u.NormalizedUserName == normalizedUserName);
                return applicationUser;
            }
            catch (Exception ex)
            {
        ...
        public async Task<string> GetNormalizedUserNameAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            try
            {
                cancellationToken.ThrowIfCancellationRequested();
                ThrowIfDisposed();
                var applicationUser = await _unitOfWork.UserRepository.GetByIdAsync(user.Id);
        ...
        public async Task<string> GetUserNameAsync(ApplicationUser user, CancellationToken cancellationToken)
        {
            try
            {
                cancellationToken.ThrowIfCancellationRequested();
                ThrowIfDisposed();
                var applicationUser = await _unitOfWork.UserRepository.GetFirstOrDefaultAsync(u => u.Id == user.Id);
                if (applicationUser != null)
                {
        ...
        public async Task<ApplicationUser> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken)
        {
            try
            {
                cancellationToken.ThrowIfCancellationRequested();
                ThrowIfDisposed();
                var applicationUser = await _unitOfWork.UserRepository.GetFirstOrDefaultAsync(u => u.NormalizedEmail == normalizedEmail);
                return applicationUser;
            }
            catch (Exception ex)
            {
